...
- Refreshed the full local release-candidate proof from clean head `016e2865`.
  ...
  Turso feature rows, explicit Rust handoff verifier tests, out-of-tree book
  artifact validation plus the executable book artifact contract, QGLake
  handoff replay through QueryGraph locked verify/import with
