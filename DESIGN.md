...
`1ea1e1c3`. `scripts/check-release-readiness.sh --release-candidate` passed
...
contract for the published `v0.1.0` baseline, out-of-tree book artifact
validation plus the executable book artifact contract, local QGLake handoff
replay verification with QueryGraph locked verify/import,
