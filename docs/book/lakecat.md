...
QueryGraph output hash is trusted. The regression suite covers the core bundle
and lineage-drain hash objects as required saved-sidecar entries. The saved
