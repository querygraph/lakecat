...
| C1-09 | in progress | catalog-bench | `catalog-bench@02a9c79` publishes the reviewed immutable 2026-08-27 contention bundle, five result records, manifest, generated matrix, failure attribution, and deterministic importer. The general one-command smoke/full profiles, cross-scenario raw-bundle publication, generated known-gaps page, and bundle-wide secret scan remain open; the contention-only publication does not promote C1-03 through C1-07 smoke transcripts into result records. |
