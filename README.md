...
QueryGraph table/view counts and semantic hashes after `lakecat-verify` and
`lakecat-import` agree, artifact paths, raw file hashes, captured LakeCat
replay output, QueryGraph verify output, QueryGraph import output, and service
log path for automation.
