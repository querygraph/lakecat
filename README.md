...
[contributor guidance](AGENTS.md), [release map](docs/RELEASES.md), and the
[LakeCat book](docs/book/lakecat.md).
...
release-candidate proof was refreshed from head `b6ade047`.
